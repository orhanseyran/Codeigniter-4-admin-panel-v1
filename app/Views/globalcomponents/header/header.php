<div class="page-header">
        ...
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="/"><img class="img-fluid" src="images/logo.png" alt=""></a></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
          </div>
          <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
              <div class="d-flex h-100"> <img src="../assets/images/giftools.gif" alt="gif">
                <h6 class="mb-0 f-w-400"><span class="font-primary">En İyi Ödeme </span><span class="f-light">Yöntemleri</span></h6><i class="icon-arrow-top-right f-light"></i>
              </div>
              <div class="d-flex h-100"><img src="../assets/images/giftools.gif" alt="gif">
                <h6 class="mb-0 f-w-400"><span class="f-light">E-Ticaret Vallet İle Daha Kolay </span></h6><a class="ms-1" href="https://www.vallet.com.tr/" target="_blank">Şimdi İncele !</a>
              </div>
            </div>
          </div>
          <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0">
                <div class="media profile-media"><img class="b-r-10" style="width: 30px;" src="images/vendor.png" alt="">
                  <div class="media-body"><span>Merhaba <?= session()->get("name") ?></span>
                    <p class="mb-0"><?= session()->get("role") ?> <i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
                <ul class="profile-dropdown onhover-show-div">
                  <li><a class="f-w-700" href="#"><i data-feather="user"></i><span>Profil</span></a></li>
